                ...
                <div class="row">
                    <div class="team-member col-md-3 col-sm-6">
                        <div class="member-thumb">
                            <img src="resources/images/member1.jpg" alt="">
                    ...
                    <div class="team-member col-md-3 col-sm-6">
                        <div class="member-thumb">
                            <img src="resources/images/member2.jpg" alt="">
                            <div class="team-overlay">
                                <h3>Cindy</h3>
                                <span>Developer</span>
                                <ul class="social">
                    ...
                    <div class="team-member col-md-3 col-sm-6">
                        <div class="member-thumb">
                            <img src="resources/images/member3.jpg" alt="">
                            <div class="team-overlay">
                                <h3>Mary</h3>
                                <span>Director</span>
                                <ul class="social">
                    ...
                    <div class="team-member col-md-3 col-sm-6">
                        <div class="member-thumb">
                            <img src="resources/images/member4.jpg" alt="">
                            <div class="team-overlay">
                                <h3>Linda</h3>
